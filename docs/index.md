...
| **_Identifier_**        | Will look something like this: *finance.trading.0.glue-job* |
| **_Development Group_** | Might look something like this: *group:datameshplatform*    |
| **Storage Area**        | *urn:dmb:cmp:finance:trading:0:s3-storage-area*             |

### Aws glue job generics

This section defines the details of the environment where the AWS Glue job will be deployed

- AWS Region: Aws region assigned to the Resource Group chosen above

*Example:*

| Field name         | Example value  |
|:-------------------|:---------------|
| **Aws Region**     | westeurope     |

The Gitlab project and repository name will be autogenerated by the template and stored on the catalog-info file.
...
- what resources your job will use